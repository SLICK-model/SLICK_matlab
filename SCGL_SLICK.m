...
% Last revision:  01-Apr-2024 Tianyi Chu <tchu72@gatech.edu; tic173@ucsd.edu>
...
for k = 1:k_max
     ...
     A_model(:,:,k)  =   invtcoeffs( permute(reshape( squeeze(Y_mc(k,1:(Nf)*M_n,(1:400))),M_n,Nf,[]),[2 1 3]),window,'firsthalf','complex');
